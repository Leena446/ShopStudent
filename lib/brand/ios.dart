...
class _IosState extends State<Ios> {
                    ...
                    child: RaisedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.pushReplacement(
                            context, MaterialPageRoute(builder: (context) => ShopModel(market: 'apple',
  ...
  dropDown2(type) {
    ...
    return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance
          .collection('Model').doc('apple').collection(type.toString())
          .snapshots(),
  ...
  dropDown3(modelName) {
    ...
    return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance
          .collection('Model').doc('apple').collection(devicetype.toString())
