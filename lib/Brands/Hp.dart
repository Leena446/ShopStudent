...
class LaptopHp extends StatefulWidget {
  @override
  _LaptopHpState createState() => _LaptopHpState();
}

class _LaptopHpState extends State<LaptopHp> {
  var firstColor =   Color(0xff03989E),  secondColor = Colors.white10;
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
          stream: FirebaseFirestore.instance
              .collection('Devices')
              .where("Device Type", isEqualTo: "Laptop")
              .snapshots(),
